...
const ADS_INVENTORY_PERMISSION = {
	id: "8132044808088489",
	parentId: "",
	label: "Ads Inventory",
	name: "adsInventory",
	...
	children: [
		{
			id: "3667930780705760",
			parentId: "8132044808088489",
			label: "Website Management",
			name: "websites",
			type: PermissionType.MENU,
			route: "websites",
			component: "/ads-inventory/websites/index.tsx",
		},
		{
			id: "3667930780705752",
			parentId: "8132044808088489",
			...
			component: "/ads-inventory/ads-management/index.tsx",
		},
	],
};
...
export const WEBSITE_LIST= [
	...
	{
		id: "3",
		domain: "healthandwellness.org",
		status: "disable",
		owner: "Alex Johnson",
		createdDate: new Date("2021-07-22"),
		desc: faker.lorem.sentence(),
	},
	{
		id: "4",
		domain: "foodlovers.net",
		status: "enable",
		owner: "Emily Davis",
		createdDate: new Date("2020-11-05"),
		desc: faker.lorem.sentence(),
	},
	{
		id: "5",
		...
		status: "enable",
		owner: "Michael Brown",
		createdDate: new Date("2019-08-19"),
		desc: faker.lorem.sentence(),
	},
];

export const ADS_FORMAT_LIST = [
...
export const ADS_INVENTORY_LIST = [
	{
		id: "1",
		website: WEBSITE_LIST[0],
		adsFormat: ADS_FORMAT_LIST[0],
		inputCode: faker.lorem.text(),
		publishCode: faker.lorem.text(),
		status: "active",
	...
	{
		id: "2",
		website: WEBSITE_LIST[1],
		adsFormat: ADS_FORMAT_LIST[1],
		inputCode: faker.lorem.text(),
		publishCode: faker.lorem.text(),
		status: "inactive",
		createdBy: USER_LIST[1],
	...
	// Additional records for WEBSITE_LIST[0]
  {
    id: "5",
    website: WEBSITE_LIST[0],
    adsFormat: ADS_FORMAT_LIST[0],
